          ...
          <div class="flex items-center">
            <VDropdown ref="sortDropdown">
              ...
              <div class="py-1">
                ...
                -->
                <a href="#" class="font-medium text-gray-900 block px-4 py-2 text-sm" tabindex="-1"> Most Popular </a>

                <a href="#" class="text-gray-500 block px-4 py-2 text-sm" tabindex="-1"> Best Rating </a>

                <a href="#" class="text-gray-500 block px-4 py-2 text-sm" tabindex="-1"> Newest </a>

                <a href="#" class="text-gray-500 block px-4 py-2 text-sm" tabindex="-1"> Price: Low to High </a>

                <a href="#" class="text-gray-500 block px-4 py-2 text-sm" tabindex="-1"> Price: High to Low </a>
              </div>
            </VDropdown>
