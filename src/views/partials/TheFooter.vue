  ...
  <footer class="bg-white">
    <div class="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
      ...
      <div class="mt-8 flex justify-center space-x-6">
        <a href="https://github.com/markofrontend/nabavi.ga" class="text-gray-400 hover:text-gray-500" target="_blank">
        ...
        <a href="https://github.com/markofrontend/api.nabavi.ga" class="text-gray-400 hover:text-gray-500" target="_blank">
          ...
          <div class="flex items-center">
            ...
            <span class="ml-1">be</span>
          </div>
        </a>
      </div>

      <p class="mt-8 text-center text-base text-gray-400">
        &copy; 2022. Simple Online Shop for University Final Task,
        <a href="https://www.ucg.ac.me/predmet/2/3/1/2017/11026-baze-podataka-napredni-kurs"
           class="underline"
           target="_blank">Course Databases</a>
      </p>
    </div>
  </footer>
