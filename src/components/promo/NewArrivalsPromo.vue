      ...
      <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 sm:static">
        <div class="sm:max-w-lg">
          ...
          <p class="mt-4 text-xl text-gray-500">
            The new arrivals have, well, newly arrived. Check out the latest options from our products while they're still in stock.
          </p>
        </div>
        <div>
          <div class="mt-10">
            ...
            <a href="#" class="inline-block text-center bg-emerald-600 border border-transparent rounded-md py-3 px-8 font-medium text-white hover:bg-emerald-700">
              Shop New Arrivals
            </a>
          </div>
        </div>
